...
use `"`c(sysdir_site)'/SIM/$pais/2020/households.dta"', clear
...
if scalar(ComprasN) < 0 {
	...
	label define to 102 "Compras por extranjeros", add
}
...
egen gasto___Educación = rsum(gasto_anual16-gasto_anual18)

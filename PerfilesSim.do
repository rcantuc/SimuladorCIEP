...
keep ISRAS ISRPF CUOTAS ISRPM IVA IEPSNP IEPSP ISAN IMPORT OTROSK FMP ///
	Pension Educación Salud IngBasico Pensión_AM Otros_gastos Otras_inversiones Part_y_otras_Apor Energía infra_entidad ///
	folio* numren edad sexo factor decil escol formal ingbrutotot ///
	asis_esc tipoesc nivel inst_* ing_jubila jubilado rural
if `c(version)' > 13.1 {

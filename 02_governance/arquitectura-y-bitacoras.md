...
| Fase 4 | Backup como componente del pipeline *(antes Fase 3)* | ✅ Implementada en código 2026-07-09 (`backup-vps.sh` + Fase 0 de `publicar-vps.sh`; §7.2 y bitácora v1.23). Pendiente: primera ejecución real |
...
Estas decisiones fueron tomadas por el investigador principal el 2026-07-10 durante sesión de diseño arquitectónico. **El diseño ya está implementado en código** (2026-07-09: `05_scripts/backup-vps.sh` + Fase 0 de `publicar-vps.sh`; decisiones de implementación I.1–I.3 al final de esta sub-sección). Ningún backup se ha corrido aún contra el VPS real: la primera ejecución real está pendiente.
...
**Estado:** implementado en código el 2026-07-09 (bitácora v1.23). Pendientes: primera ejecución real, `BACKUP_ROOT` en el credentials real, primera prueba de restauración trimestral (sugerida: octubre 2026) y un respaldo manual de llaves con `--llaves` como línea base.

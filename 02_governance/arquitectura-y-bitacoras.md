...
| Fase 3 | Diseño de pipeline `publicar-vps.sh` *(antes Fase 5)* | 🟡 Código implementado y testeado localmente (bitácora v1.21); primer deploy real pendiente de Ricardo |
| Fase 4 | Backup como componente del pipeline *(antes Fase 3)* | 🔜 Diseño preliminar en §7.2 |
| Fase 5 | Estrategia de cutover v7 → v8 *(antes Fase 4)* | 🔜 |
| Fase 6 | Prueba piloto + primer deploy | 🔜 |

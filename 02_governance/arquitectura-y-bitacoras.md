...
| Fase 4 | Backup como componente del pipeline *(antes Fase 3)* | 🔜 Diseño preliminar en §7.2 — **siguiente en el roadmap** |
...
Estas decisiones fueron tomadas por el investigador principal el 2026-07-10 durante sesión de diseño arquitectónico. **Son diseño, no ejecución**: se preservan como insumo para cuando la Fase 4 del roadmap (backup como componente del pipeline) se ejecute. Ningún backup se ha corrido aún bajo este diseño.
...
**D.8 — Ubicación de ejecución del script.** Pendiente de decidir cuando se diseñe la Fase 3 nueva (pipeline maestro). Opciones a considerar en ese momento: el script corre desde la Mac (pull), desde el VPS (push), o híbrido.

# Políticas institucionales del CIEP

Este documento reúne dos políticas que antes vivían en archivos separados de esta carpeta (fusión del 2026-07-04; la historia de cada parte se sigue con `git log --follow` sobre este archivo):

- **Parte I — Gestión de secretos y credenciales**: qué cuenta como secreto, dónde viven, quién accede a qué, y qué hacer cuando uno se compromete.
- **Parte II — Marco de ciclo de vida de productos**: qué se conserva y qué se retira cuando un producto del Ecosistema CIEP envejece o se descontinúa (documento bandera vs. micrositio).

---

# Parte I — Política de gestión de secretos del CIEP
...
# Parte II — Marco de ciclo de vida de productos del Ecosistema CIEP

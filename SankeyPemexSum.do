...
replace profile = `DerechosEnteros' - (`fmptot' + `reduccionductot' + `estimulosfiscalestot')/1000000000 in -1
...
noisily SankeySumLoop, anio(2024) name(2019_2024) folder(SankeyPemex) a(`eje1') b(`eje2') c(`eje3') d(`eje4') e(`eje5')

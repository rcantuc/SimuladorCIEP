...
* Definimos los años
local years 2015 2016 2017 2018 2019 2020 2021 2022 2024 2025 2026

* Sección 1: Definición de variables por componente y año
foreach var in Deducciones Exenciones Regimenes Diferimientos Facilidades Subsidio {
	foreach year of local years {
		scalar `var'_`year' = .
	}
}

foreach var in DeduccionesPF ExencionesPF RegimenesPF DiferimientosPF {
	foreach year of local years {
		scalar `var'_`year' = .
	}
}

foreach var in ExencionesIVA TasasRedIVA ExencionesIMPE TasasRedIMPE EstimulFiscales {
	foreach year of local years {
		scalar `var'_`year' = .
	}
}

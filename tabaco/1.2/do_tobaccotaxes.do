...
*cd "/Users/ricardo/Desktop/"
*cd "/SIM/OUT/tabaco/1"
cd "{{ruta}}"					// <-- Ruta del simulador
...
gen sales=1264.5*mktshare
replace sales=1264.5 if marca=="Cigarros"

replace precio=66.87 if marca=="Malboro rojo"
replace precio=57.99 if marca=="Pall Mall"
replace precio=50.1 if marca=="Montana"
replace precio=54.1 if marca=="Delicados"
replace precio=66.32 if marca=="Benson"
replace precio=56.77 if marca=="Otros"
replace precio=62.19356 if marca=="Cigarros"
...
** En 2021 0.51 pesos por cigarro.

*local stax_1=0.51 					// <-- PARAMETRO 1 A MODIFICAR  
...
****************************
gen pindustry_1=pindustry*1.053
...
gen minmargen_1=(pindustry_1)*0.353243602
...
** Información de ENIGH 2020** Todos los valores son trimestrales
...
*****************
capture scalar drop pibY pibVPINF pibINF lambda
scalar gi_gt = string(gi_gt_p[_N],"%10.1f")
scalar gi_gs = string(gi_gs_p[_N],"%10.1f")
scalar gi_yll = string(gi_yll_p[_N],"%10.1f")

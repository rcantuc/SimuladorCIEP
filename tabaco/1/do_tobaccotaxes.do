...
replace sales=1284.67412 if marca=="Cigarros"

*gen price=66.87 if marca=="Malboro"
*replace price=57.99 if marca=="Pall Mall"
*replace price=50.1 if marca=="Montana"
*replace price=54.1 if marca=="Delicados"
*replace price=66.32 if marca=="Benson"
*replace price=56.77 if marca=="Otros"
...
*gen stax=.5484 //
*local stax_1=.683 					// <-- PARAMETRO 1 A MODIFICAR  (esto no se que es)

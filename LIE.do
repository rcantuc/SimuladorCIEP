...
replace conceptograph = "Al ingreso" if conceptograph == "Impuesto sobre los ingresos" | conceptograph == "Impuesto sobre los Ingresos"
replace conceptograph = "Al patrimonio" if conceptograph == "Impuestos sobre el Patrimonio"

encode conceptograph, g(concept) label(concept)
collapse (sum) monto (mean) poblacion deflator pibYEnt if capitulo == "Impuestos" ///

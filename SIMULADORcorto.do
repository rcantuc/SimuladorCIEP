...
global pib2022 = {{CRECPIB2022}} //       CGPE 2023 (página 134)
global pib2023 = {{CRECPIB2023}} //    CGPE 2023 (página 134)
global pib2024 = {{CRECPIB2024}} //       CGPE 2023 (página 134)
...
global tasaEfectiva = {{DEUDA0}} // Tasa de inter{c e'}s EFECTIVA
global tipoDeCambio = {{DEUDA1}}   // Tipo de cambio  
global depreciacion = {{DEUDA2}}    // Depreciaci{c o'}n  
...
if "$update" == "update" {
	...
	scalar pemex       =   {{pemex}} //    Pemex (salud) + ISSFAM (salud)

	scalar bienestar   =   {{bienestar}} //    Pensión Bienestar
	scalar penimss     =   {{penims}} //    Pensión IMSS
	scalar penisss     =   {{peniss}} //    Pensión ISSSTE
	scalar penotro     =   {{penotr}} //    Pensión Pemex, CFE, Pensión LFC, ISSFAM, Otros
...
matrix DED = 	({{DED0}},	{{DED1}}, 			{{DED2}}, 			{{DED3}})  //            Falta este valor DED3

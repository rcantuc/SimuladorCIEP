...
quietly {
	...
	*****************************************
	...
	noisily di _newline in g "Poblaci{c o'}n al infinito: " in y %15.0fc `poblacionINF'
	noisily di _newline in g "Poblaci{c o'}n valor presente: " in y %15.0fc `poblacionVP'[1,1]

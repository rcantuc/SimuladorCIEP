...
replace ISR__asalariados = ISR*0.210/0.125 if tipo_contribuyente == 1 & ISR < 0
...
replace ISR__PM = (ing_capital-gasto_anualDepreciacion)*3.392/3.442*PM[1,1]/100*(1-PM[1,2]/100) //if formal != 0
...
* Results *
tabstat ISR__asalariados ISR__PF [fw=factor_cola] if prop_factor_cola < (1-DED[1,3]/100), stat(sum) f(%25.2fc) save
tempname SIMTAX
matrix `SIMTAX' = r(StatTotal)

tabstat ISR__PM [fw=factor_cola], stat(sum) f(%25.2fc) save
tempname SIMTAXM
